...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[18];
  RNAeval_args_info_help[16] = 0; 
  
}

const char *RNAeval_args_info_help[17];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->logML_help = RNAeval_args_info_detailed_help[16] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvT:4d:e:P:c", long_options, &option_index);

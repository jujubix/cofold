...
init_full_help_array(void)
{
  ...
  RNAcofold_args_info_full_help[28] = RNAcofold_args_info_detailed_help[40];
  RNAcofold_args_info_full_help[29] = 0; 
  
}

const char *RNAcofold_args_info_full_help[30];
...
init_help_array(void)
{
  ...
  RNAcofold_args_info_help[23] = RNAcofold_args_info_detailed_help[40];
...
void init_args_info(struct RNAcofold_args_info *args_info)
{
  ...
  args_info->betaScale_help = RNAcofold_args_info_detailed_help[38] ;

...
struct RNA2Dfold_args_info
{
  ...
  char * parameterFile_arg;	/**< @brief Read energy parameters from paramfile, instead of using the default parameter set.\n.  */
  char * parameterFile_orig;	/**< @brief Read energy parameters from paramfile, instead of using the default parameter set.\n original value given at command line.  */
  const char *parameterFile_help; /**< @brief Read energy parameters from paramfile, instead of using the default parameter set.\n help description.  */
  ...
  unsigned int parameterFile_given ;	/**< @brief Whether parameterFile was given.  */

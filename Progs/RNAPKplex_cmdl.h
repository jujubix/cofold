...
struct PKplex_args_info
{
  ...
  int energyCutoff_arg;	/**< @brief Energy cutoff or pseudoknot initiation cost. Minimum energy gain of a pseudoknot interaction for it to be returned. Pseudoknots with smaller energy gains are rejected.\n\n (default='-810').  */
  ...
  int subopts_arg;	/**< @brief print suboptimal structures whose energy difference of the pseudoknot to the optimum pseudoknot is smaller than the given value.\n (default='0').  */

...
void clear_given (struct RNAfold_args_info *args_info)
{
  ...
  args_info->dist_alpha_given = 0;
  args_info->dist_tau_given = 0;
}
...
void clear_args (struct RNAfold_args_info *args_info)
{
  ...
  args_info->dist_tau = -1.0;
  args_info->dist_alpha = -1.0;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "distAlpha") == 0)
          {
              if (update_arg( (void *)&(args_info->dist_alpha), 0, &(args_info->dist_alpha_given),
                  &(local_args_info.dist_alpha_given), optarg, 0, "-1.", ARG_DOUBLE,
                  check_ambiguity, override, 0, 0,
                  "distAlpha", '-',
                  additional_error))
                goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "distTau") == 0)
          {
              if (update_arg( (void *)&(args_info->dist_tau), 0, &(args_info->dist_tau_given),
                  &(local_args_info.dist_tau_given), optarg, 0, "-1.", ARG_DOUBLE,
                  check_ambiguity, override, 0, 0,
                  "distTau", '-',
                  additional_error))
                goto failure;

...
init_help_array(void)
{
  ...
  RNAsnoop_args_info_help[14] = RNAsnoop_args_info_detailed_help[18];
  ...
  RNAsnoop_args_info_help[22] = RNAsnoop_args_info_detailed_help[28];
  RNAsnoop_args_info_help[23] = RNAsnoop_args_info_detailed_help[29];
  RNAsnoop_args_info_help[24] = RNAsnoop_args_info_detailed_help[30];
  RNAsnoop_args_info_help[25] = RNAsnoop_args_info_detailed_help[31];
  RNAsnoop_args_info_help[26] = RNAsnoop_args_info_detailed_help[32];
  RNAsnoop_args_info_help[27] = RNAsnoop_args_info_detailed_help[33];
  RNAsnoop_args_info_help[28] = RNAsnoop_args_info_detailed_help[34];
  RNAsnoop_args_info_help[29] = RNAsnoop_args_info_detailed_help[35];
  RNAsnoop_args_info_help[30] = RNAsnoop_args_info_detailed_help[36];
  RNAsnoop_args_info_help[31] = RNAsnoop_args_info_detailed_help[37];
  RNAsnoop_args_info_help[32] = RNAsnoop_args_info_detailed_help[38];
  RNAsnoop_args_info_help[33] = RNAsnoop_args_info_detailed_help[39];
  RNAsnoop_args_info_help[34] = RNAsnoop_args_info_detailed_help[41];
  RNAsnoop_args_info_help[35] = RNAsnoop_args_info_detailed_help[43];
  RNAsnoop_args_info_help[36] = RNAsnoop_args_info_detailed_help[44];
  RNAsnoop_args_info_help[37] = RNAsnoop_args_info_detailed_help[45];
  RNAsnoop_args_info_help[38] = RNAsnoop_args_info_detailed_help[46];
  RNAsnoop_args_info_help[39] = 0; 
  
}

const char *RNAsnoop_args_info_help[40];
...
void clear_args (struct RNAsnoop_args_info *args_info)
{
  ...
  args_info->duplex_distance_arg = 1;
...
void init_args_info(struct RNAsnoop_args_info *args_info)
{
  ...
  args_info->alignment_mode_help = RNAsnoop_args_info_detailed_help[13] ;
  args_info->fast_folding_help = RNAsnoop_args_info_detailed_help[14] ;
  args_info->extension_cost_help = RNAsnoop_args_info_detailed_help[16] ;
  args_info->minimal_right_duplex_help = RNAsnoop_args_info_detailed_help[18] ;
  args_info->minimal_loop_energy_help = RNAsnoop_args_info_detailed_help[19] ;
  args_info->minimal_left_duplex_help = RNAsnoop_args_info_detailed_help[21] ;
  args_info->minimal_duplex_help = RNAsnoop_args_info_detailed_help[22] ;
  args_info->duplex_distance_help = RNAsnoop_args_info_detailed_help[23] ;
  args_info->minimal_stem_length_help = RNAsnoop_args_info_detailed_help[25] ;
  args_info->maximal_stem_length_help = RNAsnoop_args_info_detailed_help[26] ;
  args_info->minimal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[27] ;
  args_info->maximal_duplex_box_length_help = RNAsnoop_args_info_detailed_help[28] ;
  args_info->minimal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[29] ;
  args_info->maximal_snoRNA_stem_loop_length_help = RNAsnoop_args_info_detailed_help[30] ;
  args_info->minimal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[31] ;
  args_info->maximal_snoRNA_duplex_length_help = RNAsnoop_args_info_detailed_help[32] ;
  args_info->minimal_duplex_stem_energy_help = RNAsnoop_args_info_detailed_help[33] ;
  args_info->minimal_total_energy_help = RNAsnoop_args_info_detailed_help[34] ;
  args_info->maximal_stem_asymmetry_help = RNAsnoop_args_info_detailed_help[35] ;
  args_info->minimal_lower_stem_energy_help = RNAsnoop_args_info_detailed_help[36] ;
  args_info->energy_threshold_help = RNAsnoop_args_info_detailed_help[39] ;
  args_info->produce_ps_help = RNAsnoop_args_info_detailed_help[41] ;
  args_info->output_directory_help = RNAsnoop_args_info_detailed_help[43] ;
  args_info->direct_redraw_help = RNAsnoop_args_info_detailed_help[44] ;
  args_info->from_RNAup_help = RNAsnoop_args_info_detailed_help[45] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "Vs:t:S:P:Af:c:o:l:p:q:d:h:i:j:k:m:n:v:w:x:y:a:b:e:IO:NU:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'd':	/* Distance between target 3' ends of two consecutive duplexes\n.  */
          ...
          if (update_arg( (void *)&(args_info->duplex_distance_arg), 
              ...
              &(local_args_info.duplex_distance_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "duplex-distance", 'd',
              additional_error))
            goto failure;
